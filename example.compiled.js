  ...
  render: function() {
    return (
      React.createElement("div", null, 
        React.createElement("h2", null, "String options"), 
        DATA.map(function(item, index) {
          return (
            React.createElement(Flippable, {key: item.name, 
                ref: 'item-' + index, 
              ...
              React.createElement("div", {className: "phone"}, item.phone)
            )
          );
        }.bind(this)), 
        React.createElement("h2", null, "Object options"), 
        DATA.map(function(item, index) {
          return (
            React.createElement(Flippable, {key: item.name, 
               ref: 'item-obj-' + index, 
...
React.render(React.createElement(List, null), document.getElementById('example'));

},{"../index":2,"react":158}],2:[function(require,module,exports){
var React = require('react');
